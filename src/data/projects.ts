...
const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Obsidian-style tab system - open multiple notes, switch between them instantly",
      "Tag-based and title-based search with sort by modified, created or alphabetical",
      "Accessible from anywhere via Cloudflare Tunnel on a custom subdomain",
    ],
    screenshots: [],
  },
  {
